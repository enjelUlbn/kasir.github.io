...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet"
        href="<?= $main_url ?>asset/AdminLTE-3.2.0/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
    ...
    <div class="login-box slide-down" style="margin-top: -70px;">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="#" class="h1"><b><i class="fas fa-heart"></i></b>KEI</a>
            </div>
            <div class="card-body">
                ...
                <p class="my-3 text-center">
                    <strong>Copyright &copy; 2024 <span class="text-info">Kei_Kasir</span></strong>
                </p>
            </div>
            <!-- /.card-body -->
        </div>
