...
if ($kode) {
    $selectBrg = getData("SELECT * FROM tbl_barang WHERE id_barang = '$kode'");
    if (!empty($selectBrg)) {
        $selectBrg = $selectBrg[0];
    }
}
...
<div class="content-wrapper">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline card-warning p-3">
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="noNota" class="form-control" id="noNota"
                                        value="<?= $noBeli ?>">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="hidden" value="<?= $kode ? $selectBrg['id_barang'] : '' ?>">
                                <label for="namaBrg">Nama Barang</label>
                                <input type="text" name="namaBrg" class="form-control form-control-sm" id="namaBrg"
                                    value="<?= $kode ? $selectBrg['nama_barang'] : '' ?>" readonly>
                            </div>
                        </div>
                        <div class="col-lg-1">
                            <div class="form-group">
                                ...
                                <input type="number" name="stok" class="form-control form-control-sm" id="stok"
                                    value="<?= $kode ? $selectBrg['stock'] : '' ?>" readonly>
                            </div>
                        </div>
                        <div class="col-lg-1">
                            <div class="form-group">
                                ...
                                <input type="text" name="satuan" class="form-control form-control-sm" id="satuan"
                                    value="<?= $kode ? $selectBrg['satuan'] : '' ?>" readonly>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="harga" class="form-control form-control-sm" id="harga"
                                    value="<?= $kode ? $selectBrg['harga_beli'] : '' ?>" readonly>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                        ...
                        foreach ($brgDetail as $detail){ ?>
                            <tr>
                                ...
                                <td class="text-center"><a
                                        href="?idbrg=<?= $detail['kode_brg'] ?>&idbeli=<?= $detail['no_beli'] ?>&qty=<?= $detail['qty'] ?>&tgl=<?= $detail['tgl_beli'] ?>&msg=deleted"
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-9">
                                <select name="suplier" id="suplier" class="form-control form-control-sm">
                                    ...
                                    <option value="<?= $supplier['nama'] ?>"><?= $supplier['nama'] ?>
                                    </option>
                                    <?php } ?>
                                </select>
                            </div>
    ...
    document.getElementById('kodeBrg').addEventListener('change', function() {
        let kodeBrg = this.value;
        if (kodeBrg) {
            window.location.href = "?pilihbrg=" + kodeBrg;
        }
    });
    ...
    // dapat memilih tanggal yang lama hingga tanggal hari ini
