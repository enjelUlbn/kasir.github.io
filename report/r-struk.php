...
<body>
    ...
    <table style="border-bottom: dotted 2px; font-size: 14px;width: 240px;">
        ...
        <tr>
            ...
            <td style="width: 10px; text-align:rigth;"><?= $item['qty'] ?></td>
            <td style="width: 70px; text-align:rigth;">x <?= number_format($item['harga_jual'],0,',','.') ?></td>
            <td style="width: 70px; text-align:rigth;" colspan="2"><?= number_format($item['jml_harga'],0,',','.') ?>
            </td>
        </tr>
        <?php
        }
