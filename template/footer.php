...
<footer class="main-footer">
    <strong>Copyright &copy; 2024 <span class="text-info">Kei Kasir</span></strong>
    All rights reserved.
...
<script src="<?= $main_url ?>asset/AdminLTE-3.2.0/plugins/datatables-responsive/js/dataTables.responsive.min.js">
</script>
<script src="<?= $main_url ?>asset/AdminLTE-3.2.0/plugins/datatables-responsive/js/responsive.bootstrap4.min.js">
</script>
